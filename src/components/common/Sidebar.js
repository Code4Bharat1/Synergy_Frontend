    ...
    >
      ...
      <div className="p-2 border-t border-gray-100">
        <button
          ...
          className="group relative w-full flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium text-gray-600 hover:bg-gray-50 hover:text-red-500 transition-all"
        >
          <LogOut size={18} />
