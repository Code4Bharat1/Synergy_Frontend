...
import { Bell, CheckSquare, Clock, X, BellDot, CheckCircle2, Circle } from "lucide-react";
...
export default function NotificationPanel({ userRole }) {
  ...
  return (
    <div className="relative" ref={panelRef}>
      ...
      >
        {unreadCount > 0 ? <BellDot size={20} className="text-blue-500" /> : <Bell size={20} />}
        {unreadCount > 0 && (
                    ...
                    {notifications.slice(0, 5).map((notification) => (
                      ...
                      <div className="mt-1 flex-shrink-0">
                        {notification.isRead ? (
                          ...
                          <Circle size={18} className="text-blue-500 fill-blue-50/50" />
                        )}
                      </div>
