    ...
    >
      <div
        style={{
          ...
          borderRadius: "50%",
          background:
            "linear-gradient(135deg, #1C4D8D 0%, #4988C4 60%, #BDE8F5 100%)",
          display: "flex",
          alignItems: "center",
...
function SectionTitle({ icon: Icon, title }) {
  return (
    ...
    >
      ...
      <span style={{ color: "#0F2854", fontWeight: 700, fontSize: 14 }}>
        {title}
      </span>
    </div>
  );
  ...
  return (
    <div
      style={{
        ...
        alignItems: "center",
        padding: "11px 0",
        borderBottom: "1px solid rgba(73,136,196,0.08)",
      }}
    >
      <span style={{ color: "#4988C4", fontSize: 12, minWidth: 130 }}>
        {label}
      </span>
      {editable && editMode ? (
        <input
        ...
        <span style={{ color: "#0F2854", fontSize: 13, fontWeight: 600 }}>
          {value}
        </span>
      )}
    </div>
  ...
  return (
    ...
    >
      <div>
        ...
        {sub && (
          <div style={{ color: "#4988C4", fontSize: 11, marginTop: 2 }}>
            {sub}
          </div>
        )}
      </div>
...
export default function SupportProfilePage() {
  ...
  return (
    <div
      style={{ fontFamily: "'DM Sans', 'Segoe UI', sans-serif", maxWidth: 900 }}
    >
      {/* ── Page Header ──────────────────────────────────────────────────── */}
      <div style={{ marginBottom: 28 }}>
        ...
        <h1
          style={{ color: "#0F2854", fontSize: 26, fontWeight: 800, margin: 0 }}
        >
          My Profile
        </h1>
        ...
        >
          <div
            style={{
              ...
              inset: 0,
              backgroundImage:
                "radial-gradient(circle at 20% 50%, rgba(189,232,245,0.12) 0%, transparent 60%), radial-gradient(circle at 80% 20%, rgba(189,232,245,0.08) 0%, transparent 50%)",
            }}
          />
        </div>
          ...
          <Card style={{ padding: "22px" }}>
            ...
            <div
              style={{
                marginTop: 18,
                background:
                  "linear-gradient(135deg, rgba(15,40,84,0.05), rgba(73,136,196,0.08))",
                borderRadius: 12,
                padding: "14px 16px",
                border: "1px solid rgba(73,136,196,0.15)",
                display: "flex",
            ...
            >
              ...
              <div>
                <div
                  style={{ color: "#0F2854", fontSize: 13, fontWeight: 700 }}
                >
                  Senior Field Agent
                </div>
                <div style={{ color: "#4988C4", fontSize: 11, marginTop: 2 }}>
                  Top 10% resolution rate · 3 years tenure
                </div>
              </div>
            </div>
          </Card>
                  ...
                  style={{
                    ...
                    borderBottom:
                      i < RECENT_ACTIVITY.length - 1
                        ? "1px solid rgba(73,136,196,0.08)"
                        : "none",
                  }}
                >
                  {/* dot */}
              ...
              {[
                ...
                >
                  <div>
                    ...
                    <div style={{ color: "#4988C4", fontSize: 11 }}>
                      {s.location}
                    </div>
                  </div>
                  {s.current ? (
            ...
            >
              <div>
                ...
                <div style={{ color: "#4988C4", fontSize: 13 }}>
                  Signing out will end your current session and require
                  re-authentication.
                </div>
              </div>
              <button
        ...
        >
          <Card style={{ padding: "22px" }}>
            ...
            <Toggle
              ...
              checked={notifs.newComplaint}
              onChange={(v) => setNotifs((n) => ({ ...n, newComplaint: v }))}
            />
            <Toggle
              label="Status Updates"
              sub="When complaint status changes"
              checked={notifs.statusUpdate}
              onChange={(v) => setNotifs((n) => ({ ...n, statusUpdate: v }))}
            />
            <Toggle
              label="Material Ready Alert"
              sub="When requested material is dispatched"
              checked={notifs.materialReady}
              onChange={(v) => setNotifs((n) => ({ ...n, materialReady: v }))}
            />
            <Toggle
              label="Critical Complaint Alert"
              sub="Immediate alert for critical severity"
              checked={notifs.criticalAlert}
              onChange={(v) => setNotifs((n) => ({ ...n, criticalAlert: v }))}
            />
          </Card>
          ...
          <Card style={{ padding: "22px" }}>
            ...
            <Toggle
              ...
              sub="Every Monday — complaints overview"
              checked={notifs.weeklyReport}
              onChange={(v) => setNotifs((n) => ({ ...n, weeklyReport: v }))}
            />
            <Toggle
              label="Daily Email Digest"
              sub="Morning summary of open complaints"
              ...
              {[
                {
                  ...
                  body: "CMP-009 · Speed Slide Classic · SunSplash Inc.",
                  time: "Just now",
                  color: "#4988C4",
                  active: notifs.newComplaint,
                },
                {
                  title: "Critical Alert",
                  body: "CMP-005 · Funnel Ride X2 · Ocean World",
                  time: "5 min ago",
                  color: "#FF3B30",
                  active: notifs.criticalAlert,
                },
                {
                  title: "Material Dispatched",
                  body: "Gel Coat Resin · 5kg for CMP-001",
                  time: "1 hour ago",
                  color: "#FF9500",
                  active: notifs.materialReady,
                },
              ]?.map((n, i) => (
                <div
                  key={i}
                ...
                >
                  <div
                    style={{
                      ...
                      height: 8,
                      borderRadius: "50%",
                      background: n.active ? n.color : "#ccc",
                      flexShrink: 0,
                    }}
                  />
                  <div style={{ flex: 1 }}>
