...
`}
        ...
        >
          ...
          <p style={{ color: "#4988C4", fontSize: 14, marginBottom: 24 }}>
            Your issue has been filed and the relevant department has been
            notified.
          </p>
          <button
            onClick={() => {
...
`}
      ...
      <div className="il-grid">
        ...
        <Card style={{ padding: "26px" }}>
          <SectionHead
            icon={<AlertTriangle size={16} color="#BDE8F5" />}
            title="Issue Details"
          />
              ...
              {recentIssues?.map((issue) => (
                ...
                >
                  ...
                  >
                    ...
                    <span
                      style={{
                        background: `${sevColorMap[issue.severity]}18`,
                        color: sevColorMap[issue.severity],
                        padding: "1px 8px",
                        borderRadius: 99,
                        fontSize: 10,
                        fontWeight: 700,
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 6 }}>
              {DEPARTMENTS?.map((d) => (
                ...
                >
                  ...
                  />
                  <span style={{ color: "#1C4D8D", fontSize: 12 }}>
                    {d.name}
                  </span>
                </div>
              ))}
