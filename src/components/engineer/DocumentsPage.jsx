            ...
            >
              ...
              <div className="text-center">
                ...
                <p className="text-xs text-gray-400 mt-0.5">
                  PDF, DOC, XLSX, images — up to 5 files
                </p>
              </div>
            </label>
                    ...
                    >
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <p className="text-xs text-gray-400">
                          {formatSize(f.size)} · .{f.ext.toUpperCase()}
                        </p>
                      </div>
                      <button
                        type="button"
          ...
          <>
            ...
            <label className="flex flex-col items-center justify-center gap-2 w-full border-2 border-dashed border-gray-200 hover:border-blue-300 hover:bg-gray-50 rounded-xl py-8 cursor-pointer transition-all">
              ...
              <div className="text-center">
                ...
                <p className="text-xs text-gray-400 mt-0.5">
                  All supported files inside will be uploaded
                </p>
              </div>
            </label>
              ...
              <div className="mt-3 space-y-2 max-h-48 overflow-y-auto">
                ...
                {folderFiles?.map((f, idx) => {
                  ...
                  return (
                    <div
                      key={idx}
                      className={`flex items-center gap-3 px-3 py-2 rounded-xl border border-gray-100 ${meta.bg}`}
                    >
          ...
          return (
            ...
            >
              ...
              <div className="flex-1">
                <p
                  className={`text-xs font-semibold ${done ? "text-green-700" : "text-gray-700"}`}
                >
                  {v.label}
                </p>
                <p className="text-xs text-gray-400">
      ...
      {recent.length === 0 ? (
        ...
        <div className="space-y-2">
          {recent?.map((d) => {
            ...
            const projectName =
              typeof d.project === "object" ? d.project?.name : null;
            return (
              <div
                key={d._id}
                onClick={() => onView(d)}
...
export default function DocumentsPage() {
  ...
  const handleStatClick = (key) => {
    setFilterStatus(
      key === "total" ? "all" : (prev) => (prev === key ? "all" : key),
    );
  };
      ...
      <div className="flex items-center justify-between flex-wrap gap-3">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-0.5">
            Submit handover docs, trial formats & maintenance manuals
          </p>
        </div>
        <div className="flex items-center gap-2">
          <button
        ...
        {[
          ...
          return (
            ...
            >
              ...
              {isActive && (
                <p className={`text-xs font-semibold mt-1 ${s.color}`}>
                  ● Active
                </p>
              )}
            </button>
