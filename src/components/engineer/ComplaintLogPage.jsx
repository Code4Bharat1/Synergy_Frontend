...
import { MessageSquare, Plus, Trash2, CheckCircle, Upload, AlertCircle } from "lucide-react";
import {
  ...
  if (submitted) return (
    <>
      ...
      <div style={{ maxWidth: 480, margin: "80px auto", textAlign: "center" }}>
        ...
        <h2 style={{ color: "#0F2854", fontSize: 22, fontWeight: 800, fontFamily: "'Syne',sans-serif", marginBottom: 8 }}>
          Complaint Logged!
        </h2>
      ...
      {error && (
        <div style={{
          ...
          <button onClick={() => setError(null)} style={{
            ...
            cursor: "pointer", color: "#FF3B30", fontSize: 16,
          }}>×</button>
        </div>
      )}
