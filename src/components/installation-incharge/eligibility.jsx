  ...
  return (
    <div className={`bg-white rounded-2xl border shadow-sm p-4 transition-all
      ...
      <div className="h-1.5 bg-gray-100 rounded-full mb-3 overflow-hidden">
        <div
          className={`h-full rounded-full transition-all duration-500 ${isUnassigned ? "bg-amber-300" : "bg-blue-700"}`}
          ...
          <div className="flex gap-1 bg-blue-100/60 rounded-xl p-1 w-full sm:w-auto">
            {[
              ...
              <button
                ...
                className={`flex-1 sm:flex-none px-3 py-2 rounded-lg text-xs sm:text-sm font-semibold transition-all duration-200 whitespace-nowrap ${
                  filter === f.key
                    ? f.key === "unassigned"
