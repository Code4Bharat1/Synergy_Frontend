...
const deriveSeverity = (text = "") => {
  ...
  if (
    ...
    return "High";
  if (t.includes("medium") || t.includes("paint") || t.includes("delamination"))
    return "Medium";
  return "Low";
};
...
export default function IssueApproval() {
  ...
  const resolve = async () => {
    ...
    try {
      ...
      const newStatus =
        modal.type === "approve" || modal.type === "resolve"
          ? "resolved"
          : "in-progress";
  ...
  return (
    <div className="min-h-screen bg-slate-50 font-sans text-blue-950 flex flex-col">
      ...
      <div className="px-4 sm:px-6 lg:px-8 pt-6 pb-4 flex items-center justify-between flex-wrap gap-3">
        ...
        <div className="flex items-center gap-2 flex-wrap">
          {[
            ...
            {
              label: `${counts["in-progress"]} In Progress`,
      ...
      <div className="flex flex-1 overflow-hidden">
        {/* LEFT — list */}
        <div
          className={`${showDetail ? "hidden" : "flex"} lg:flex flex-col w-full lg:w-80 lg:shrink-0 bg-white border-r border-gray-100`}
        >
          {/* Filter tabs */}
              ...
              return (
                ...
                >
                  <div className="flex justify-between items-center mb-1.5">
                    <span
                      className={`text-[11px] font-bold tracking-wide ${isActive ? "text-blue-700" : "text-gray-400"}`}
                    >
        ...
        {/* RIGHT — detail */}
        <div
          className={`${!showDetail ? "hidden" : "flex"} lg:flex flex-1 flex-col overflow-y-auto px-4 sm:px-6 lg:px-8 py-5`}
        >
          {!active ? (
                ...
                <div className="max-w-3xl w-full">
                  ...
                  <div className="mb-5">
                    ...
                    <p className="text-xs text-gray-400">
                      Logged by {active.createdBy?.name || "—"} ·{" "}
                  ...
                  {active.photo && (
                    <div className="bg-white border border-gray-100 rounded-2xl p-4 mb-4">
                      <p className="text-xs font-bold text-blue-950 mb-2">
                        Attached Photo
                      </p>
                      <img
                        src={active.photo}
                  ...
                  {(active.status === "resolved" ||
                    ...
                    ${active.status === "resolved" ? "bg-green-50 border-green-200" : "bg-blue-50 border-blue-200"}`}
                      ...
                      ${active.status === "resolved" ? "bg-green-100" : "bg-blue-100"}`}
                        ...
                        <div>
                          <p
                            className={`text-xs font-bold mb-1 ${active.status === "resolved" ? "text-green-700" : "text-blue-700"}`}
                          >
                            {active.status === "resolved"
                              ? "Resolved"
                              : "In Progress"}{" "}
                  ...
                  {active.status === "open" && (
                    <div className="flex gap-3 flex-wrap">
                      <button
                        onClick={() =>
                          setModal({ id: active._id, type: "approve" })
                        }
                      ...
                      <button
                        onClick={() =>
                          setModal({ id: active._id, type: "reject" })
                        }
                  ...
                  {active.status === "in-progress" && (
                    <div className="flex gap-3 flex-wrap">
                      <button
                        onClick={() =>
                          setModal({ id: active._id, type: "resolve" })
                        }
              ...
              <div className="bg-white rounded-2xl w-full max-w-md shadow-2xl overflow-hidden">
                <div className="px-5 py-4 border-b border-gray-100 flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    <div
                      className={`w-9 h-9 rounded-xl flex items-center justify-center ${isApprove ? "bg-green-50" : "bg-blue-50"}`}
                    >
                      {isApprove ? (
                        <svg
                          width="15"
                ...
                <div className="px-5 py-4">
                  ...
                  <div className="grid grid-cols-2 gap-3 mb-4">
                    {[
                      {
                        label: "Department",
                        value: issue.responsibleDepartment,
                      },
                  ...
                  <textarea
                    ...
                    placeholder={
                      isApprove
                        ...
                        : "Reason for marking in progress..."
                    }
                    rows={3}
