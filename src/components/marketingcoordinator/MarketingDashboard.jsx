...
import {
  ...
  User, Package, Calendar1, CheckCircle,
} from "lucide-react";
...
const PENDING_REPLICATIONS = [
  { id: "REP-001", project: "Al Barsha Mall Signage", status: "Pending",   incharge: "Ahmed Karimi", items: 8,  due: "10 Mar 2025" },
  { id: "REP-002", project: "Downtown Billboard",      status: "In Review", incharge: "Sara Malik",   items: 3,  due: "14 Mar 2025" },
  { id: "REP-003", project: "JBR Promenade Wrap",      status: "Approved",  incharge: "Tom Reeves",   items: 12, due: "18 Mar 2025" },
];
...
export default function MarketingDashboard() {
  ...
  useEffect(() => { setCoordName(getCoordinatorName()); }, []);
          ...
          <div className="rounded-2xl bg-white shadow-sm p-5">
            ...
            {docs.loading && (
              <div className="space-y-2.5">
                {[1, 2, 3].map(i => (
                  <div key={i} className="rounded-xl bg-brand-bg/50 px-3.5 py-2.5 flex items-center justify-between">
            ...
            {docs.error && !docs.loading && (
              <div className="flex items-center gap-2 rounded-xl bg-red-500/5 border border-red-400/20 px-3.5 py-2.5">
                ...
                <span className="text-[11px] text-red-500 font-medium">{docs.error}</span>
                <button onClick={docs.refetch} className="ml-auto text-[11px] font-bold text-red-500 underline">Retry</button>
              </div>
            )}
            ...
            {!docs.loading && !docs.error && docs.data.length === 0 && (
              <div className="flex flex-col items-center justify-center py-6 gap-2">
                ...
                <p className="text-[12px] text-brand-mid font-medium">All documents are up to date</p>
              </div>
            )}
                ...
                {docs.data.map(doc => (
                  <div key={doc.id} className={[
                    ...
                    <span className={[
                      ...
                      doc.due === "Overdue" ? "bg-red-500/12 text-red-500"
                      : doc.due === "Today" ? "bg-orange-500/12 text-orange-500"
